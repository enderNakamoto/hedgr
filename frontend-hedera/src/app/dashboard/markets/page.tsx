                          ...
                          <div className="space-y-4">
                            ...
                            {vaultAddress && (
                              <div className="flex items-center gap-1 text-sm">
                                ...
                                <a
                                  href={`https://hashscan.io/testnet/account/${vaultAddress}`}
                                  target="_blank"
                                  rel="noopener noreferrer"
                            ...
                            {factoryAddress && (
                              <div className="flex items-center gap-1 text-sm">
                                ...
                                <a
                                  href={`https://hashscan.io/testnet/account/${factoryAddress}`}
                                  target="_blank"
                                  rel="noopener noreferrer"
                                  className="flex items-center gap-1 text-primary hover:underline"
                                >
                            ...
                            {controllerAddress && (
                              <div className="flex items-center gap-1 text-sm">
                                ...
                                <a
                                  href={`https://hashscan.io/testnet/account/${controllerAddress}`}
                                  target="_blank"
                                  rel="noopener noreferrer"
                                  className="flex items-center gap-1 text-primary hover:underline"
                                >
