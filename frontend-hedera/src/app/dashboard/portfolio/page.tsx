                                  ...
                                  <CardContent className="p-6 space-y-4">
                                    ...
                                    <div className="space-y-3">
                                      ...
                                      <div className="flex items-center gap-1 text-sm">
                                        ...
                                        <a
                                          href={`https://hashscan.io/testnet/account/${position.contractAddress}`}
                                          target="_blank"
                                      ...
                                      <div className="flex items-center gap-1 text-sm">
                                        ...
                                        <a
                                          href={`https://hashscan.io/testnet/account/${position.factoryAddress}`}
                                          target="_blank"
                                          rel="noopener noreferrer"
                                          className="flex items-center gap-1 text-primary hover:underline"
                                        >
                                      ...
                                      <div className="flex items-center gap-1 text-sm">
                                        ...
                                        <a
                                          href={`https://hashscan.io/testnet/account/${position.controllerAddress}`}
                                          target="_blank"
                                          rel="noopener noreferrer"
                                          className="flex items-center gap-1 text-primary hover:underline"
                                        >
