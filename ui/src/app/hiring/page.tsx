          ...
          <div>
            <div className="bg-secondary rounded-lg p-8 shadow-lg">
              ...
              <p className="text-gray-700 mb-6">
                HedgeWave is building the future of crypto hedging with the XRPL
                and RLUSD. We're looking for passionate individuals who want to
                make an impact in the world of decentralized finance.
              </p>
