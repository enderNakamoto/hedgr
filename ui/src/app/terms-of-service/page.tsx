      ...
      <div className="container max-w-4xl mx-auto px-4 py-16 flex-1">
        ...
        <div className="space-y-6 text-gray-700">
          <section>
            ...
            <p>
              By accessing or using HedgeWave, you agree to be bound by these
          ...
          <section>
            ...
            <p>
              HedgeWave provides a crypto hedging platform powered by the XRP
              Ledger. Our services enable users to protect their digital assets
              against market volatility through various hedging strategies.
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              All content, features, and functionality of the HedgeWave
              platform, including but not limited to text, graphics, logos, and
              software, are owned by HedgeWave and are protected by intellectual
              property laws.
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              To the maximum extent permitted by law, HedgeWave and its
          ...
          <section>
            ...
            <p>
              ...
              the laws of the jurisdiction in which HedgeWave is registered,
